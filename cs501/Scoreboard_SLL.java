...
public class Scoreboard_SLL {
    ...
    public static void main(String[] args) {
        ...
        Scoreboard_SLL testBoard =  test0.getBoard();
    ...
    private static void displayScores(Scoreboard_SLL board) {
        System.out.println("-------------------------------------------");
    ...
    private static class Tester {
        ...
        public Scoreboard_SLL getBoard(){
            return scoreboard;
        }

        public void Test() {
            GameEntry e;
            scoreboard = new Scoreboard_SLL();
